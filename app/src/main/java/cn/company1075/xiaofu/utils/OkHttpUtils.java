...
public class OkHttpUtils {
     ...
     * @param callBack
     */
    private void getJsonStringMethod(final String jsonValue, final FuncJsonString callBack) {
     ...
     * @param callBack
     */
    private void getJsonObjectMethod(final String jsonValue, final FuncJsonObject callBack) {
        handler.post(new Runnable() {
            @Override
            public void run() {
                if (callBack != null) {
     ...
     * @param callBack
     */
    private void getJsonByteMethod(final byte[] data, final FuncJsonObjectByte callBack) {
        handler.post(new Runnable() {
            @Override
            public void run() {
                if (callBack != null) {
     ...
     * @param callback
     */
    public void getJsonStringByURL(String url, final FuncJsonString callback) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response != null && response.isSuccessful()) {
                    getJsonStringMethod(response.body().string(), callback);
                }
            }
        });
    }
     ...
     * @param callback
     */
    public void getJsonObjectByURL(String url, final FuncJsonObject callback) {
        final Request request = new Request.Builder().url(url).build();
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response != null && response.isSuccessful()) {
                    getJsonObjectMethod(response.body().string(), callback);
                }
            }
        });
    }
    ...
    public void syscGetByteByURL(String url, final FuncJsonObjectByte callback) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response != null && response.isSuccessful()) {
                    getJsonByteMethod(response.body().bytes(), callback);
                }
            }
        });
    }
     ...
     * @param callback 提交回调
     */
    public void sendFilefForClicent(String url, Request request, final FuncJsonString callback) {
