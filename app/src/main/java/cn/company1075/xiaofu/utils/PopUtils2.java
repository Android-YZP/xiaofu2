...
public class PopUtils2 {
     ...
     */
    public PopUtils2(Context context, int layoutResId, int width, int height, View view, int gravity, int x, int y, ClickListener callback) {
    ...
    public static class PopBuilder {
        ...
        public static PopBuilder createPopupWindow(final Context context, int layoutResId, int width, int height, View parent, int gravity, int x, int y, ClickListener callback) {
            ...
            ColorDrawable dw = new ColorDrawable(context.getResources().getColor(android.R.color.white));
